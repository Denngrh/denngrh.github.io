...
!(function ($) {
  ...
  $(window).on("load", function () {
    ...
    // Tambahkan kode untuk filter certifications
    $("#certifications-flters li").on("click", function () {
      $("#certifications-flters li").removeClass("filter-active");
      $(this).addClass("filter-active");
  ...
  document.addEventListener("DOMContentLoaded", function () {
    document.querySelectorAll(".scroll-container").forEach((container) => {
      const clone = container.innerHTML; // Clone isi container
      container.innerHTML += clone; // Gandakan agar seamless
    });
  });
})(jQuery);
